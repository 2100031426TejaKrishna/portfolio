...
const Skills = () => {
  ...
  const skills = ['Java', 'C', 'SQL', 'Django', 'React.js', 'JavaScript', 'PowerBI', 'HTML/CSS', 'Excel', 'Database Management'];
  ...
  const certifications = [
    ...
    },
    {
      ...
      image: ai,
      link: 'https://www.credly.com/badges/626c0a37-3783-4990-af37-d7b36916d84b/linked_in?t=rw2tg4',
    },
    {
