  ...
  return (
    <Card>
      ...
      <Content>
        <h2>About Me</h2>
        <Info>
          I’m Teja Krishna, a final year student at KL University, pursuing B.Tech in Computer Science. I have a current CGPA of 9.68/10. I possess strong problem-solving and web development skills, which have enabled me to complete various projects across different stacks and participate in hackathons.
        </Info>
        <Info>
          Apart from academics, I have also published a research paper on Chat Bot and recommendation systems through IEEE organization, which is a significant milestone for me. In my free time, I enjoy painting, animations, and creating filters on Instagram.
        </Info>
        <Share>
          <Anchor href="https://github.com/2100031426TejaKrishna">
          ...
          <Anchor href="https://www.linkedin.com/in/your-linkedin-profile">
          ...
          <Anchor href="https://www.instagram.com/_krish._.83/">
